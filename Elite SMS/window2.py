...
class Ui_MainWindow1(object):
    ...
    def getData(self):  
        ...
        try:
            conn = mysql.connector.connect(host='localhost',user='root',password='',database='user_data')

            mycur = conn.cursor()

            sql = "INSERT INTO user_info (vehicle_no, mobile_no, date) VALUES (%s,%s,%s)"
            val = (self.vehicleNum, self.mobileNum, self.newExpiryDate)
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setFixedSize(614,400)
